window.onload = function() {
  ...
  if(window === window.top) {
    ...
    var imgURL = safari.extension.getURL('icon_open_chat_panel.png');
    document.getElementById('SwapcastEmbedded_AppBtn').style.backgroundImage = 'url("' + imgURL + '")';

    imgURL = safari.extension.getURL('ajax-loader_.gif');
    ...
    try {
      ...
      eventer(messageEvent,function(e) {
        ...
        if (data != null && data.indexOf('swapcast-') !== -1) {
          ...
          safari.runtime.sendMessage({unreadMessagesCount: content}, function() { });
